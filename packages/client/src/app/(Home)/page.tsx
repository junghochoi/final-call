...
import { Titan_One, Coiny, DynaPuff } from "next/font/google"
...
export default function Home() {
	...
	return (
		<div className="h-[calc(100vh-64px)] lg:max-w-screen-lg mx-auto  flex flex-col ">
			<div className="m-12">
				<h1 className={cn("text-center text-6xl font-bold text-white", dynaPuff.className)}>Final Call</h1>
				<h2 className={cn("text-center text-white", dynaPuff.className)}>Game of Rags to Riches</h2>
			</div>

			<div className="flex justify-center items-stretch">
				<div className="flex flex-col gap-6 w-2/3 lg:flex-row lg:w-3/4">
					<div className="p-6 rounded flex flex-col justify-center items-center gap-6 w-full lg:w-1/2 bg-black bg-opacity-15">
						<h2 className={cn("text-center text-white", dynaPuff.className)}>Future Avatar Selector</h2>
					...
					<div
						className={cn(
							"p-6 rounded w-full lg:w-1/2 shadow-lg text-center text-white bg-black bg-opacity-15",
							dynaPuff.className
						)}
					>
